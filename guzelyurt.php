...
<div class="routespage" style="background: url(images/guz.jpg) no-repeat left;">
        <div class="inner-page">
            <h1>Guzelyurt Shuttles</h1>
            <p class="taxt">
               Guzelyurt is a city just outside lefke. The bus moves every thirty minutes and only stops after it has enter Gaziveren.Below is an image of all the
