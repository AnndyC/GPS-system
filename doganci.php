...
<div class="routespage"  style="background: url(images/doganci.jpg) no-repeat left;">
        <div class="inner-page">
            <h1>Doganci Shuttles</h1>
            <p class="taxt">
               Doganci has buses moving to and from every hour daily. it paases through Yesilyurt and also stops in Gziveren. Below is an image of all the
