...
<div class="routespage" style="background: url(images/lefke.jpg) no-repeat left;">
        <div class="inner-page">
            <h1>Lefke Shuttles</h1>
            <p class="taxt">
               Some of the school dorms are in Lefke. Buses move to and from every hour during the week and every two hours on Sunday. Below is an image of all the
