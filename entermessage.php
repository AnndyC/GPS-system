...
<body>
    ...
    <div class="aboutus3">
      ...
      <div class="row">
        ...
        <div class="column">
          <form action="routespage.php" method="post">
            <label for="date">Enter date</label>
            <input type="text"  name="date" placeholder="the date..">
            <label for="title">Enter title</label>
            <textarea type="text" name="title" placeholder="Write something.." ></textarea>
            ...
            <button name="updatemessage_btn" type="submit"> + add message</button>
          </form>
        </div>
